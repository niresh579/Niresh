...
public class NegativePaymentAssisted {
...
//                  driver.setLogLevel(Level.INFO);
   	...
   	BaseTest.click(rp.getLogin());
   	 ...
   	 Thread.sleep(8000);
   	  ...
   	  Thread.sleep(4000);
   	  BaseTest.click(rp.getAssisted());
   	  
   	  
   	 try {
 		Thread.sleep(4000);
 		driver.findElement(By.xpath("//div[@class='gmg_chat_close']")).click();
 	} catch (Exception e2) {
   ...
   /// popup////
    ...
    Thread.sleep(4000);
    BaseTest.click(rp.getSixmonthassisted());
...
/////back////
   ...
   /// popup////
    ...
    Thread.sleep(4000);
    BaseTest.click(rp.getOneyearassisted());
