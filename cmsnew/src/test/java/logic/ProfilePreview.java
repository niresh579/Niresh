      ...
      // System.out.println(split2[0]);
       ...
       Thread.sleep(4000);
         ...
         if (piage==profilepreviewage) {
          ...
          if (starown.equalsIgnoreCase(starown1)) {
          ...
          if (ownraasi.equalsIgnoreCase(ownraasi1)) {
        	  System.out.println("Raasi is Matched");
			
		}
          
          else {
			System.out.println("Raasi is Not Matched");
		}      
