...
public static String getExcelDataUrl(String sheetName, int rowNum, int colNum) throws Throwable{
	FileInputStream fis = new FileInputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\WFM\\excel\\SMSTEST.xlsx");
...
public static void setExcelData(String sheetName, int rowNum, int colNum,String data) throws Throwable{
 ...
 FileOutputStream fos = new FileOutputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\WFM\\excel\\SMSTEST.xlsx");
	wb.write(fos);
	wb.close();
}
