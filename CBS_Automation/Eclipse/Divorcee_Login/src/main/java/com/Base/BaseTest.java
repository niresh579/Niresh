...
String mobileno="919790920593,919841165519,919884323735,919789980446,919952966400,919942886072,919840870629,918098882244";
//"917010752043,916302165648,919789352793,919840870629,919840870629,919841165519,919444086906,919952119197,917299972503,919092343056,919790920593";
//,916302165648,919840870629";
String[] s = mobileno.split(",");
for (int i = 0; i < s.length; i++) {
	...
	public static void reportflush(String a , String b , String c)
	{
	    ...
	    try {
	       ...
	       // " Level 1 " +"\n" + "Error on : Login Test " + "\n" + "Error Description : " + error + "\n"  + " Reported to : No Response " +"\n" + "Domain Name : " + domain + "\n" + test.getStartedTime() +"" ;
	        ...
	        String file = ".//ScreenShot//divorceeLogin.png";
...
//C:\Users\CBS\Downloads
  		  ...
  		  public static void reportflush_level3(String a , String b , String c)
  		{
  			extent.flush();    	
  			final String username = "cbsautomationreport@gmail.com";
  		    final String password = "cbstest123";
  		    ...
  		    try {
  		        ...
  		        message.setRecipients(Message.RecipientType.TO,                                                                                                                                                                                                                                                         //,919790920593
  		                    InternetAddress.parse("visvesvarryya.neelakantan@matrimony.com,dhanapal@bharatmatrimony.com,thiru.murugan@matrimony.com,kannan.elangovan@matrimony.com,mohanasundaram.natarajan@matrimony.com,suresh.nithyanandam@matrimony.com,cbstesting@matrimony.com"));
  		                    		//"sai.jyothi@matrimony.com,amudhan.nagarajan@matrimony.com,thanikachalam.thirunanasambandan@matrimony.com,ashokkumar@bharatmatrimony.com,dhanapal@bharatmatrimony.com,kalanithi@bharatmatrimony.com,senthilnath.subramani@matrimony.com,raja.sekar@matrimony.com,visvesvarryya.neelakantan@matrimony.com"));
  		           //,thanikachalam.thirunanasambandan@matrimony.com                        
  		        Multipart multipart = new MimeMultipart();
  		       ...
  		       // " Level 1 " +"\n" + "Error on : Login Test " + "\n" + "Error Description : " + error + "\n"  + " Reported to : No Response " +"\n" + "Domain Name : " + domain + "\n" + test.getStartedTime() +"" ;
  	             //CBS Automation Report - Mail for Script Failed With Resson"+"\n"+ "Domain : " +domain+"\n"+"Error on : " +error+ "\n"+ " Error Reason : " + expt + "
  		        String file = ".//ScreenShot//divorceeLogin.png";
  		     //   String file1 = "C:\\Users\\CBS\\eclipse-workspace\\Sample_Project\\Report\\MyReport.html";
