...
public static String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
 ...
 String destination = "C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\ScreenShot\\" +screenshotName+".png";
 ...
 return destination;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 public static void sendVFSms1() throws Exception {
         ...
         //,919789352793";
         //919840870629,917010752043,919840870629,919841165519,919444086906,919952119197,917299972503,919092343056";
...
"http://api.myvaluefirst.com/psms/servlet/psms.Eservice2";
 ...
 public static void sendVFSms_Fail3(String domain , String error , String expt) throws Exception {
     ...
     String mobileno="919790920593,919841165519,919884323735,919789980446,919952966400,919942886072,919840870629,918098882244";//"919789352793,919840870629,917010752043,919840870629,919841165519,919444086906,919952119197,917299972503,919092343056,919790920593";
     String[] s = mobileno.split(",");
     for (int i = 0; i < s.length; i++) {
     String url ="http://api.myvaluefirst.com/psms/servlet/psms.Eservice2";
     URL obj = new URL(url);
...
"http://api.myvaluefirst.com/psms/servlet/psms.Eservice2";
  ...
  public static String getExcelData(String sheetName, int rowNum, int colNum) throws Throwable{
		FileInputStream fis = new FileInputStream("C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\Excel\\SMSTEST.xlsx");
	...
	public static void setExcelData(String sheetName, int rowNum, int colNum,String data) throws Throwable{
      ...
      FileOutputStream fos = new FileOutputStream("C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\Excel\\SMSTEST.xlsx");
		wb.write(fos);
		wb.close();
	}
	...
	public static void reportflush(String a , String b , String c)
	{
	    ...
	    try {
	       ...
	       // " Level 1 " +"\n" + "Error on : Login Test " + "\n" + "Error Description : " + error + "\n"  + " Reported to : No Response " +"\n" + "Domain Name : " + domain + "\n" + test.getStartedTime() +"" ;
	        ...
	        String file = "C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\ScreenShot\\payment.png";

	        String fileName = "CBS-AutomationReport-Desktop";
	        DataSource source = new FileDataSource(file);
	       // messageBodyPart.setDataHandler(new DataHandler(source));
	        attachmentBodyPart.setDataHandler(new DataHandler(source));
	        attachmentBodyPart.setFileName("payment.png");
   ...
   //  Pass Level 1
	    ...
	    public static void reportflush2()
	  		{
	  		    ...
	  		    try {
	  		       ...
	  		       // " Level 1 " +"\n" + "Error on : Login Test " + "\n" + "Error Description : " + error + "\n"  + " Reported to : No Response " +"\n" + "Domain Name : " + domain + "\n" + test.getStartedTime() +"" ;
	  	             //CBS Automation Report - Mail for Script Failed With Resson"+"\n"+ "Domain : " +domain+"\n"+"Error on : " +error+ "\n"+ " Error Reason : " + expt + "
	  		        String file = "C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\Report\\MyReport.html";
	    ...
	    public static void reportflush3()
	  		{
	  		    ...
	  		    public static void reportflush_Fail3(String a , String b , String c)
	  			{
	  			    ...
	  			    try {
	  			        ...
	  			        message.setRecipients(Message.RecipientType.TO,
	  			                    InternetAddress.parse("visvesvarryya.neelakantan@matrimony.com,dhanapal@bharatmatrimony.com,thiru.murugan@matrimony.com,kannan.elangovan@matrimony.com,mohanasundaram.natarajan@matrimony.com,suresh.nithyanandam@matrimony.com,cbstesting@matrimony.com"));
	  			                    	 //,thanikachalam.thirunanasambandan@matrimony.com,ashokkumar@bharatmatrimony.com,dhanapal@bharatmatrimony.com,kalanithi@bharatmatrimony.com,senthilnath.subramani@matrimony.com, raja.sekar@matrimony.com,kalanithi@bharatmatrimony.com"));
	  			           //,thanikachalam.thirunanasambandan@matrimony.com                        
	  			        Multipart multipart = new MimeMultipart();
	  	   ...
	  	   //  Pass Level 3
	  		    ...
	  		    public static void reportflush_pass3()
	  		  		{
	  		  			extent.flush();    	
	  		  			final String username = "cbsautomationreport@gmail.com";
	  		  		    final String password = "cbstest123";
	...
	public void htmlReport() {
	    ...
	    // extent = new ExtentHtmlReporter("C:\\Users\\amuthan\\eclipse-workspace\\com.mobile\\ScreenShot");
		 ...
		 extent=new ExtentReports("C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\Report\\"+html,true);
		 extent.loadConfig(new File("C:\\Users\\CBS\\eclipse-workspace\\CBS_Payment1\\extent-config.xml"));
