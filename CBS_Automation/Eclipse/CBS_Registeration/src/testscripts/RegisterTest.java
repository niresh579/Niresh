...
public class RegisterTest extends BaseTest{	
	...
	test=extent.createTest("Register Module -Test");
		...
		FileInputStream file1 = new FileInputStream(new File(".//Resources//RegisterTestData1.xlsx")); 
		Workbook workbook1 = WorkbookFactory.create(file1);
		Sheet sheet1 = workbook1.getSheetAt(0);
		FileInputStream file2 = new FileInputStream(new File(".//Resources//RegisterTestData2.xlsx")); 
