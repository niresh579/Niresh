...
public static String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
 ...
 String destination = "C:\\Users\\CBS\\eclipse-workspace\\Divorcee_Payment\\ScreenShot\\" +screenshotName+".png";
...
"http://api.myvaluefirst.com/psms/servlet/psms.Eservice2";
  ...
  public static String getExcelData(String sheetName, int rowNum, int colNum) throws Throwable{
		FileInputStream fis = new FileInputStream("C:\\Users\\CBS\\eclipse-workspace\\Divorcee_Payment\\Excel\\SMSTEST.xlsx");
	...
	public static void setExcelData(String sheetName, int rowNum, int colNum,String data) throws Throwable{
      ...
      FileOutputStream fos = new FileOutputStream("C:\\Users\\CBS\\eclipse-workspace\\Divorcee_Payment\\Excel\\SMSTEST.xlsx");
		wb.write(fos);
		wb.close();
	}
	...
	public static void reportflush(String a , String b , String c)
	{
	    ...
	    try {
	        ...
	        message.setRecipients(Message.RecipientType.TO,
	                    InternetAddress.parse("ashokkumar@bharatmatrimony.com,cbsautomationreport@gmail.com,amukural@gmail.com"));
	       ...
	       // " Level 1 " +"\n" + "Error on : Login Test " + "\n" + "Error Description : " + error + "\n"  + " Reported to : No Response " +"\n" + "Domain Name : " + domain + "\n" + test.getStartedTime() +"" ;
	        ...
	        String file = "C:\\Users\\CBS\\eclipse-workspace\\Divorcee_Payment\\ScreenShot\\divorceePayment.png";
   ...
   //  Pass Level 1
	    ...
	    public static void reportflush2()
	  		{
	  		    ...
	  		    try {
	  		        ...
	  		        message.setSubject("[CBS-QA-ALERT-LEVEL 1]["+ status + " :  SUCCESS]");
	...
	public void htmlReport() {
	    ...
	    // extent = new ExtentHtmlReporter("C:\\Users\\amuthan\\eclipse-workspace\\com.mobile\\ScreenShot");
		 ...
		 extent=new ExtentReports("C:\\Users\\CBS\\eclipse-workspace\\Divorcee_Payment\\Report\\"+html,true);
		 extent.loadConfig(new File("C:\\Users\\CBS\\eclipse-workspace\\Divorcee_Payment\\extent-config.xml"));
