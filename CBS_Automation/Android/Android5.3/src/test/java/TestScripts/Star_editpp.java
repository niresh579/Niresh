...
public class Star_editpp extends BaseTest {
	...
	public void testUntitled() throws Throwable {
		...
		for (int i = 0; i <= 0; i++) {
			...
			// driver.scrollToExact("MotherTongue").getText();
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			BaseTest.click(driver.findElement(By.xpath("//*[@id='partnerreligious_edit']")));
			Thread.sleep(5000);
			BaseTest.click(driver.findElement(By.xpath("//*[@id='edit_txt_partner_star_value']")));
			Thread.sleep(5000);
			if (mtongue_ei.equals("Tamil")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 0);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
					String star1 = driver.findElement(By.xpath("//*[@id='refine_adapter_checkBox']")).getText();
			...
			if (mtongue_ei.equals("Bengali")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 1);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Marathi")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 2);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Gujarati")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 3);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Punjabi")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 4);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Hindi")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 5);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Sindhi")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 6);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Kannada")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 7);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Kerala")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 8);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Telugu")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 9);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Marwadi")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 10);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Parsi")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 11);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Assamese")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 12);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Oriya")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 13);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
			...
			if (mtongue_ei.equals("Urdu")) {
				for (int j = 1; j <= 27; j++) {
					String star = BaseTest.getExcelData("Sheet4", j, 14);
					System.out.println(star);
					Thread.sleep(5000);
					driver.findElement(By.xpath("//*[@id='search_editText']")).sendKeys(star);
					Thread.sleep(5000);
		...
		@Test(priority =1)
		public void testUntitled1() throws Throwable {
			...
			//(//*[@id='recy_filter']/*/*/*[@id='img_arrow' and @height>0 and ./parent::*[(./preceding-sibling::* | ./following-sibling::*)[@height>0]]])[7]
	driver.findElement(By.xpath("(//*[@id='recy_filter']/*/*/*[@id='img_arrow' and @height>0 and ./parent::*[(./preceding-sibling::* | ./following-sibling::*)[@height>0]]])[7]")).click();	
	Thread.sleep(5000);
