    ...
    public void testUntitled() throws InterruptedException {
		...
		for (int i = 0; i <= 0; i++) {
			try {
				...
				Thread.sleep(2000);
				BaseTest.typeData(l1.getEnter_Matrid(), "IYR360046");
				Thread.sleep(2000);
		...
		Thread.sleep(5000);
		BaseTest.typeData(p.getEdit_Number_txt(), "8098882244");
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		BaseTest.typeData(p.getName_field(), "sairani");
		Thread.sleep(5000);
		// height//
		...
		Thread.sleep(5000);
		BaseTest.typeData(p.getReg_search_btn(), "india");
		Thread.sleep(5000);
