...
public class Agrressive_pp {
	...
	public void testUntitled() throws InterruptedException {
		...
		for (int i = 0; i <= 0; i++) {
			...
			/*
			 * String output = (CharMatcher.JAVA_LETTER).retainFrom(profile_count);
			 * System.out.println("ggghh" + output); Thread.sleep(8000); for(String
			 * w:profile_count.split("\\s",2)){ System.out.println(w); }
			 */
			/*
			 * Thread.sleep(8000);
			 * 
			 * String[] split = profile_count.split(" "); String content =
			 * split[1].toString(); String content1 = split[2].toString(); String content2 =
			 * split[3].toString(); String content3 = split[4].toString(); String content4 =
			 * split[5].toString(); String content5 = split[6].toString();
			 * 
			 * System.out.println(content + content1 + content2 + content3 + content4 +
			 * content5);
			 * 
			 * 
			 * 
			 * 
			 * System.out.println(content); if (just_joined.equals(content)) {
			 * System.out.println("just joined content verified");
			 * 
			 * }
			 */
			Thread.sleep(8000);
