...
public class Mothertongue_EI extends BaseTest {
	...
	public void testUntitled() throws Throwable {
		...
		for (int i = 0; i <= 0; i++) {
			try {
				...
				BaseTest.typeData(l.getEnter_Matrid(), "AGR100173");
			...
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id='edit_txt_star_value']")).click();
			Thread.sleep(5000);
			...
			//String[] array= {"Telugu","Tamil","Urdu","Sindhi","kannada",""
			try {
