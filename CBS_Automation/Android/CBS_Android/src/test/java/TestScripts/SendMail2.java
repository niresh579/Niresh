...
public class SendMail2 extends BaseTest {
    ...
    public void sendMailTest2() throws Exception {
    	...
    	if (l.getView_reply_mailbox().isDisplayed()) {
    		...
    		Thread.sleep(5000);
    		BaseTest.typeData(l.getView_reply_mailconten(), BaseTest.readValueFromExcelSheet().get(2).get("MailContent"));
    		Thread.sleep(5000);
    	...
    	Thread.sleep(5000);
    	if (driver.findElement(By.xpath("//*[@text='YES' and @height>0]")).isDisplayed()) {
    		Thread.sleep(5000);
    		driver.findElement(By.xpath("//*[@text='YES' and @height>0]")).click();
    		try {
    			Thread.sleep(5000);
			...
			Thread.sleep(5000);
              System.out.println("There is no member to send Interest");
		}
