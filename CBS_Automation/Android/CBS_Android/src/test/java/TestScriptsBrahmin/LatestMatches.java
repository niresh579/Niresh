...
import java.net.URL;
	...
	public class LatestMatches extends BaseBrahmin {
	    ...
	    public void latestMatchesTest() throws Exception {
	    	...
	    	POMBrahmin.Login l = new POMBrahmin.Login(driver);
	    	Thread.sleep(5000);
	    	//*[@id='matriid_from_login_layout']
	    	try { 	
		...
		System.out.println("Already Logged In");
	    	...
	    	Thread.sleep(5000);
	    //	BaseTestBrahmin.click(l.getLatest_matches());
	    	...
	    	Thread.sleep(5000);
	    	BaseBrahmin.click(l.getSend_interest());
			} else {
	    	...
	    	try {
				...
				driver.findElement(By.xpath("//*[@text='Upgrade Now']")).click();
				 if (l.getSkip_membership_package().isDisplayed()) {
					 BaseBrahmin.click(l.getSkip_membership_package());
		            	Thread.sleep(5000);
		            	try {
		            		BaseBrahmin.click(l.getMembership_call_skip());
	    	...
	    	if (l.getSend_mail().isDisplayed()) {
	    		...
	    		Thread.sleep(5000);
	    		BaseBrahmin.click(l.getSend_mail());
            ...
            if (l.getIgnore_block_dropdown().isDisplayed()) {
            	...
            	if (l.getMark_as_viewed().isDisplayed()) {
            		BaseBrahmin.click(l.getMark_as_viewed());
				}
