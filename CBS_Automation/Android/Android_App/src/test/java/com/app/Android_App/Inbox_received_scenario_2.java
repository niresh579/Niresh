...
public class Inbox_received_scenario_2 extends BaseTest {
	...
	public void testUntitled() throws InterruptedException {
		...
		try {
			b.click(p.getEnter_matri_Id1());//NIC159837
			b.typeData(p.getEnter_matri_Id1(), "AGR754453");
			Thread.sleep(5000);
		...
		try {
			...
			System.out.println("no filter present");
		}
