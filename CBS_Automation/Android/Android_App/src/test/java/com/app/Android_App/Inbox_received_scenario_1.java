...
public class Inbox_received_scenario_1 extends BaseTest {
	...
	public void testUntitled() throws InterruptedException {
		...
		try {
			b.click(p.getEnter_matri_Id1());//CHR1479779
			b.typeData(p.getEnter_matri_Id1(), "AGR159159");
			Thread.sleep(5000);
		...
		try {
			Thread.sleep(5000);
			driver.findElement(By.xpath("(//*[@class='android.widget.LinearLayout' and ./parent::*[@id='mTabLayout']]/*/*[@text and @class='android.widget.TextView' and @height>0])[1]")).click();
		} catch (Exception e) {
