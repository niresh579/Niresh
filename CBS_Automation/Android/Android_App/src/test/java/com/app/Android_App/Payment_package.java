...
public class Payment_package extends BaseTest {
	...
	public void testUntitled() throws InterruptedException {
		...
		try {
			...
			b.typeData(p1.getEnter_matri_Id1(), "AGR754665");
			Thread.sleep(5000);
	...
	public void testUntitled1() throws InterruptedException {
		...
		Thread.sleep(3000);
		b.typeData(pm.getCard_number(), BaseTest.readValueFromExcelSheet().get(1).get("cardnumber"));
		Thread.sleep(3000);
		...
		// BaseTest.readValueFromExcelSheet().get(1).get("expiryyear"));
		// Thread.sleep(3000);
		// b.click(pm.getEnter_expiry_month_year());
