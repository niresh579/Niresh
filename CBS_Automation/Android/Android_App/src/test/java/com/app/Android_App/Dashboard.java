...
public class Dashboard extends BaseTest {
	...
	public void testUntitled() throws InterruptedException {
		...
		try {
			b.click(pp.getEnter_matri_Id1());// MUS2066206
			b.typeData(pp.getEnter_matri_Id1(), "BRH2393065");
			Thread.sleep(5000);
			b.typeData(pp.getEnter_password1(), "cbstest8");
			Thread.sleep(5000);
	...
	public void testUntitled1() throws InterruptedException {
		...
		try {
			...
			if (driver.findElement(By.xpath("//*[@text='ADD HOROSCOPE']")).isDisplayed()) {
				...
				Thread.sleep(5000);
				b.typeData(pp.getSearch_checkbox_btn(), BaseTest.readValueFromExcelSheet().get(1).get("country"));
				Thread.sleep(5000);
				...
				Thread.sleep(5000);
				b.typeData(pp.getSearch_checkbox_btn(), BaseTest.readValueFromExcelSheet().get(1).get("state"));
				Thread.sleep(5000);
				b.click(pp.getValue_select());
				b.click(pp.getSelect_ok_btn());
				...
				Thread.sleep(5000);
				b.typeData(pp.getSearch_checkbox_btn(), BaseTest.readValueFromExcelSheet().get(1).get("city"));
				Thread.sleep(5000);
				b.click(pp.getValue_select());
				b.click(pp.getSelect_ok_btn());
				...
				Thread.sleep(5000);
				b.typeData(pp.getSearch_checkbox_btn(), BaseTest.readValueFromExcelSheet().get(1).get("horoscope"));
				Thread.sleep(5000);
				b.click(pp.getValue_select());
				b.click(pp.getSelect_ok_btn());
		...
		try {
			...
			if (driver.findElement(By.xpath("//*[@text='ADD DETAILS']")).isDisplayed()) {
				...
				b.typeData(pp.getSearch_checkbox_btn(), BaseTest.readValueFromExcelSheet().get(1).get("star"));
				b.click(pp.getValue_select());
				b.click(pp.getSelect_ok_btn());
		...
		try {
			...
			System.out.println("swipe not possible");

			/*
			 * driver.swipe(startx, y, endx, y, 4000); driver.swipe(startx, y, endx, y,
			 * 4000); driver.swipe(startx, y, endx, y, 4000); driver.swipe(startx, y, endx,
			 * y, 4000); driver.swipe(startx, y, endx, y, 4000); driver.swipe(startx, y,
			 * endx, y, 4000);
			 */
			...
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@text='VIEWED NOT CONTACTED']")).click();
			Thread.sleep(5000);
		...
		try {
			if (ip.getView_Reply().isDisplayed()) {
				...
				// BaseTest.readValueFromExcelSheet().get(1).get("message"));
				Thread.sleep(5000);
