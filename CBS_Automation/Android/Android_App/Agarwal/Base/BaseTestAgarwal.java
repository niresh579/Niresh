...
public class BaseTestAgarwal {
	...
	public void htmlReport() {
		...
		reports.loadConfig(new File(
				"C:\\Users\\Jyothi\\.eclipse\\Android_App\\extent\\extentreports-java-2.41.2\\extent-config.xml"));
	...
	public static List<HashMap<String, String>> readValueFromExcelSheet() throws NullPointerException {
		...
		try {
			File excelLocaltion = new File("C:\\Users\\Jyothi\\.eclipse\\Android_App\\Excel\\BrahminData.xlsx");
	...
	public void reportflush() {
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("cbsautomationreport@gmail.com"));
 ...
 * @AfterMethod
 * 
 * public void getResult(ITestResult result){ if(result.getStatus() ==
 ...
 * 
 * String screenshotPath = "D:\\Android HTML Report\\Screenshot-Fails\\"; //To
 * add it in the extent report test.log(LogStatus.FAIL,
