	...
	String driverExecutablePath = "C:\\Users\\CBS Testing\\workspace\\Niresh\\cmsnew\\drivernew1\\chromedriver.exe"; 
     ...
     ExtentTest logger;
       ...
       public void testUntitled() throws Throwable {
		...
		Thread.sleep(4000);
		WebElement lang=driver.findElement(By.xpath("//*[@id='chkbox2_4']"));
		if (lang.isEnabled()) {
			System.out.println("älready selected");
		}
		else {
		...
		Thread.sleep(4000);
		WebElement caste=driver.findElement(By.xpath("//*[@id='chkbox1348_1']"));
		if (caste.isEnabled()) {
			System.out.println("älready selected");
		}
		else {
...
//			 
		...
		///pp check/////
		  ...
		  String[] split6=ppae1.split("18 yrs - ");
