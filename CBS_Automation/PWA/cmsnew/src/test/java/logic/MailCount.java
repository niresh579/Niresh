...
public class MailCount {
	...
	BaseTest.click(rp.getLogin());
	  ...
	  Thread.sleep(6000);
	  driver.findElement(By.xpath("/html/body/ion-app/ng-component/page-dashboard/ion-header/header/ion-navbar/div[2]/ion-grid/ion-row/ion-col[2]")).click();
	  
	  BaseTest.getScreenshot(driver, "Mail count popup");
