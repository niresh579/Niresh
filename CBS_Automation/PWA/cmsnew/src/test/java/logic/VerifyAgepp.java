...
/*	char ch =b3.charAt(0);
	char ch1 =b3.charAt(5);
	String s1=b3.substring(12, 15);
	System.out.println("Height :"+ch); 
	System.out.println("feet :"+ch1);
	System.out.println("centimeter :"+s1); 
	
	char minheight=ch;
  int minheightfinal=Character.getNumericValue(minheight);  */
