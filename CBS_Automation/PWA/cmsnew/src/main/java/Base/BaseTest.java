...
//////////////////////	    Screen SHot    //////////////////////////////////////
	...
	FileInputStream fis = new FileInputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\cmsnew\\excel\\Registration1.xls");
	      Workbook wb = WorkbookFactory.create(fis);
	      Sheet sh = wb.getSheet(sheetName);
	...
	public static List<HashMap<String, String>> readValueFromExcelSheet()  throws NullPointerException  {
		...
		try {
			File excelLocaltion = new File("C:\\Users\\CBS Testing\\workspace\\Niresh\\cmsnew\\excel\\Registration1.xls");
