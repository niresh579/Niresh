...
public class PreferredLocation extends BaseTest{
	 ...
	 private String reportDirectory = "reports";
	    ...
	    public void preferredLocation() throws Throwable {
	      ...
	      DiscoverMatch d = new DiscoverMatch(driver);
	    	...
	    	if (d.getPREFERRED_LOCATION().isDisplayed()) {
			
	    	
	    	Thread.sleep(10000);
	    	BaseTest.click(d.getPREFERRED_LOCATION());
	    	Thread.sleep(3000);
	    	...
	    	for (int i = 0; i < chips.size(); i++) {
	    	 ...
	    	 String Location_profile = driver.findElement(By.xpath("//ion-col[contains(text(),'State')]//following::ion-col")).getText();
	    	 System.out.println(Location_profile);
	    	 
	    	 
	    	 if (location.contains(Location_profile)||location.equalsIgnoreCase(Location_profile)) {
			...
			System.out.println("There is no Location Matches");
