...
public class PreferredEducation extends BaseTest {
	 ...
	 private String reportDirectory = "reports";
	    ...
	    public void preferredLocation() throws Throwable {
	      ...
	      DiscoverMatch d = new DiscoverMatch(driver);
	    	...
	    	if (d.getPREFERRED_EDUCATION().isDisplayed()) {
			
	    	
	    	Thread.sleep(10000);
	    	BaseTest.click(d.getPREFERRED_EDUCATION());
	    	Thread.sleep(3000);
	    	...
	    	for (int i = 0; i < chips.size(); i++) {
	    	 ...
	    	 String Occupation_detail = driver.findElement(By.xpath("//ion-col[contains(text(),'Education  ')]//following::ion-col[1]")).getText();
	    	 System.out.println(Occupation_detail);
	    	 
	    	 
	    	 if (location.contains(Occupation_detail)||location.equalsIgnoreCase(Occupation_detail)) {
			...
			System.out.println("There is no Education Matches");
