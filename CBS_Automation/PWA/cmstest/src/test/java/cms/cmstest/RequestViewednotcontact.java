...
public class RequestViewednotcontact extends Base{
    ...
    String driverExecutablePath = "C:\\\\Users\\\\CBS Testing\\\\workspace\\\\Niresh\\\\cmstest\\\\drivernew\\\\chromedriver.exe";
      ...
      ExtentTest logger;
        ...
        public void testUntitled() throws InterruptedException {
        	RequestViewednotcontactPOM rp= new RequestViewednotcontactPOM(driver);
	...
	Thread.sleep(5000);
	Base.btnclick(rp.getViewednotcontact());
		   	

 	 Thread.sleep(5000);
	 List<WebElement> ref = driver.findElements(By.xpath("//span[@class='clr36 font10']"));
