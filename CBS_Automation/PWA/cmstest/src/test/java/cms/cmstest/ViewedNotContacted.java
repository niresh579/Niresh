...
public class ViewedNotContacted extends Base {
	...
	ExtentTest logger;
	  ...
	  public void testUntitled() throws InterruptedException {
		  ...
		  Thread.sleep(5000);
			...
			Thread.sleep(4000);
			a.sendKeys(e,"chy410863").build().perform();
		  ...
		  Thread.sleep(4000);
		  driver.findElement(By.xpath("//*[@id='menusegment']/ion-segment-button[4]")).click();
		  ...
		  //shortlist
			 Thread.sleep(4000);
				  ...
				  Thread.sleep(4000);
				WebElement element = driver.findElement(By.xpath("/html/body/ion-app/ng-component/page-matches/ion-content/div[2]/ion-list/ion-row[3]/ion-grid/ion-row[1]/ion-col[2]/div[1]/div/span"));
