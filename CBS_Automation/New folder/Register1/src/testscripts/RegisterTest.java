...
public class RegisterTest extends BaseTest{	
	public static String baseurl,matriid,communitysite;
	...
	test=extent.createTest("Register Module -Test");
		...
		for (int i=3; i<=3; i++) {
			...
			Thread.sleep(2000);
			InetAddress ip = InetAddress.getByName(new URL("https://www.nepalimatrimony.com/")
                    .getHost());
...
//             System.out.println("Public IP Address of: " + ip);
		...
		//	driver.findElement(By.xpath("//*[@id=\"home-register\"]/div/div/nav/ul/li[2]/a")).click();
						...
						communitysite =sheet1.getRow(i).getCell(0).getStringCellValue();
					...
					String mobileno=sheet1.getRow(i).getCell(18).getStringCellValue()+Math.round(Math.random()*978);
...
BussinessFunctions.registrationPage1( driver, properties, communitysite, profileby, name,gender,date1, month, year, martial, relgion,denominations, 
			...
			//	driver.findElement(By.id("subCasteText")).sendKeys("vadama");
			}
...
try {			
	...
	// TODO: handle exception
		...
		Thread.sleep(5000);
	       ...
	       // driver.navigate().back(); 
	        Thread.sleep(1000);
	        driver.findElement(By.id("pinNo")).sendKeys(pinnotext);
	        ...
	        try {
				Thread.sleep(3000);
				driver.findElement(By.xpath("/html/body/form/div/div/div/div[2]/div[2]/div[4]/input")).click();
				
				Thread.sleep(3000);
				driver.findElement(By.xpath("/html/body/form/div/div/div/div[2]/div[2]/div[8]/input")).click();
	        ...
	        try {
	        	...
	        	Thread.sleep(3000);
				driver.findElement(By.xpath("/html/body/form/div/div/div/div[2]/div[2]/div[12]/a")).click();
	       ...
	       leavePage.accept();
	        }catch(Exception e)
	        {
	    		...
	    		Thread.sleep(2000);
	    		String Gender = driver.findElement(By.xpath("//*[@id=\"strictflag\"]/div[26]")).getText().trim();
