...
public class BussinessFunctions extends ActionDrivers{
	...
	try {		
			...
			} else if (martial.equals("Separated")) {
				click(RegisterPage1.martialStatus(driver, properties.getProperty("MaritalStatus_Seperated")));
...
//		
	try {	
		...
		} else if (communitysite.equals("nepalimatrimony")) {
	...
	type(RegisterPage1.subcastIfOthers(driver,properties.getProperty("subcastOthers")),Sub_cast_IfOther);
		...
		driver.findElement(By.id("mobileNo")).sendKeys("9889875732");
	...
	try {	selectElementByVisibleText(RegisterPage2.ResidingState_dropdown(driver, properties.getProperty("ResidingState_dropdown")),residestate);
		Thread.sleep(1000);
	} catch (Exception e) {
		type(RegisterPage2.ResidingState_text(driver, properties.getProperty("ResidingState_text")),residestate);
		Thread.sleep(1000);
	}
	...
	try {
		...
		type(RegisterPage2.ResidingCity_text(driver, properties.getProperty("ResidingCity_text")),residecity);
		Thread.sleep(1000);
	}	
	...
	try {			
		...
		Thread.sleep(3000);
		try {
			driver.findElement(By.id("manglik_m80")).click();
		} catch (Exception e) {
			// TODO: handle exception
		}
...
try {		
	...
	// TODO: handle exception
		...
		try {
		driver.findElement(By.xpath("//*[@id=\"annualIncome\"]")).sendKeys("150000");
		} catch (Exception e) {
...
private static void relgiousCommonInfo(WebDriver driver,Properties properties,String division,String star,String rasi,String gothram,String dosham, String doshamType,
	...
	//	driver.findElement(By.id("manglik_m4")).click();
		...
		// Naga
		Thread.sleep(1000);
	//	driver.findElement(By.id("manglik_m5")).click();
		
		// kala Sarpha
		Thread.sleep(1000);
	//	driver.findElement(By.id("manglik_m10")).click();
		
		// Raahu
		Thread.sleep(1000);
	//	driver.findElement(By.id("manglik_m20")).click();
		
		// Kethu
		Thread.sleep(1000);
	//	driver.findElement(By.id("manglik_m40")).click();
