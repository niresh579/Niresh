...
public class Block  extends Base{
	...
	WebDriver driver;
	   ...
	   public void shortList() throws InterruptedException, AWTException {
		   ...
		   Base.typeData(i.getMatriId(), "NEP135691");
	...
	//		 driver.findElement(By.xpath("//*[@id=\"save_srch_link\"]/div[5]/div[3]/input")).click();
			...
			Thread.sleep(1000);
			wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@id=\"sc_conversation_top_"+IDd+"\"]"))));
			Base.click(driver.findElement(By.xpath("//*[@id=\"sc_conversation_top_"+IDd+"\"]")));
			
			///////// /////// /////////  Scroll Using Javascripts //////// //////////
			
			
			js.executeScript("arguments[0].scrollIntoView();", driver.findElement(By.xpath("//*[@id=\"loadProfileValue\"]/ng-include/div/div[3]/div/div")));
			...
			Thread.sleep(3000);
			wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@id=\"ignoredrop_1_"+IDd+"\"]/div[3]"))));
			Base.click(driver.findElement(By.xpath("//*[@id=\"ignoredrop_1_"+IDd+"\"]/div[3]")));
