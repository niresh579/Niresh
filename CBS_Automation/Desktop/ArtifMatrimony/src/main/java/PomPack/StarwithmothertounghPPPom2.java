...
public class StarwithmothertounghPPPom2 extends Base3 {
	public StarwithmothertounghPPPom2(WebDriver driver) {
	...
	@FindBy(xpath="//*[@id='show_partner']/a")
	private WebElement PPE;
	public WebElement getPPE() {
		return PPE;
	}

	@FindBy(xpath="//*[@id='show_partner']/a")
	private WebElement PPeditclick1;
	
	
	public WebElement getPPeditclick1() {
		return PPeditclick1;
	}
