...
public class ProfilecompletedPom extends Base3 {
	public ProfilecompletedPom(WebDriver driver) {
	...
	@FindBy(xpath="//*[@id='userpop']/div[2]/div/div[2]/div[2]/div/div/a")
	private WebElement completeprofile;
	
	
	public WebElement getCompleteprofile() {
		return completeprofile;
	}

	@FindBy(xpath="//*[@id='lp-container']/div[5]/div[3]/div[2]/div[2]/a[1]")
	private WebElement Fromcomputer;
	
	public WebElement getFromcomputer() {
		return Fromcomputer;
	}
	
	@FindBy(xpath="//*[@id='addmycomp']/div/div")
	...
	private WebElement profileclick2;
	...
	@FindBy(xpath="//a[@class='settings-editprofile']")
	...
	public WebElement getProfileclick2() {
		return profileclick;
	}
