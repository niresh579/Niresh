...
public class ViewedmyprofilePom extends Base3 {
	...
	@FindBy(xpath="//span[text()='viewed your profile']")
	private WebElement viewyourprofile;
	
	@FindBy(xpath="//span[@class='clr6']")
	private WebElement viewyourprofilenextpage;
	...
	public WebElement getViewyourprofilenextpage() {
		return viewyourprofilenextpage;
	}
