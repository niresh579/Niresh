...
public class Daily7Test extends Base {
	...
	//	Map<String, String> horoscope = response.jsonPath().getMap("")
				
				Map<String, String> details = response.jsonPath().getMap("NAME");
				System.out.println("NAme "+details);
				
			
				HashMap<String, String> map = new HashMap<String, String>();
				System.out.println(map.get("MEMBERINFO"));
			//	map.put("OPPOSITEMATRIID", "MATRIID");
			//	map.put (2, "Tarryn");
			...
			//	Map<String, String> status = details.addAll(c)
