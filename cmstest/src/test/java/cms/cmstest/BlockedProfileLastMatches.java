...
public class BlockedProfileLastMatches extends Base {
...
//        
        Thread.sleep(5000);
        driver.findElement(By.xpath("/html/body/ion-app/ng-component/page-matches/ion-content/div[2]/ion-list/ion-row[1]/ion-grid/ion-row[1]/ion-col[2]/div[3]/ion-row/ion-col[2]/ion-icon")).click();
       
		Thread.sleep(6000);
		driver.findElement(By.xpath("/html/body/ion-app/ng-component/page-matches/ion-content/div[2]/ion-list/ion-row[1]/ion-grid/ion-row[1]/ion-col[2]/div[3]/ion-row/ion-col[2]/ion-list/button/div[1]/div")).click();
		Thread.sleep(4000);
