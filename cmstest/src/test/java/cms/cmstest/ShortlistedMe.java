...
public class ShortlistedMe extends Base{
...
//               driver.setLogLevel(Level.INFO);
	  ...
	  public void testUntitled() throws InterruptedException {
		  ShortlistedMePom rp= new ShortlistedMePom(driver);
		  Thread.sleep(5000);
		 ...
		 // driver.findElement(By.xpath("//*[@id='menusegment']/ion-segment-button[6]")).click();
		  driver.findElement(By.xpath("//span[contains(text(),'SHORTLISTED ME')]")).click();
		  ...
		  try {
			...
			Thread.sleep(4000);
			System.out.println("No profiles in Shortlisted Me section");
		}
