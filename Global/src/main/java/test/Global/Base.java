...
//////////////////////        Screen SHot //////////////////////////////////////
    ...
    public static String getExcelData(String sheetName, int rowNum, int colNum) throws Throwable{
		FileInputStream fis = new FileInputStream("C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\excel\\Wrongpasswordcheck.xlsx");
    ...
    //  ((FileInputStream) wb).close();
      ...
      public static int getExcelData1(String sheetName, int rowNum, int colNum) throws Throwable{
            FileInputStream fis = new FileInputStream("C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\excel\\test.xls");
                  Workbook wb = WorkbookFactory.create(fis);
                  Sheet sh = wb.getSheet(sheetName);
                  Row row = sh.getRow(rowNum);
    ...
    FileInputStream fis = new FileInputStream("E:\\SVN_CODE\\Global\\Nepali\\CBS_1\\Excel\\Wrongpasswordcheck.xlsx");
          Workbook wb = WorkbookFactory.create(fis);
          Sheet sh = wb.getSheet(sheetName);
    ...
    FileInputStream fis = new FileInputStream("C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\excel\\test.xls");
          ...
          FileOutputStream fos = new FileOutputStream("C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\excel\\test.xls");
    wb.write(fos);
    ((FileInputStream) wb).close();
    }
    ...
    public static List<HashMap<String, String>> readValueFromExcelSheet()  throws NullPointerException  {
        ...
        try {
            File excelLocaltion = new File("E:\\SVN_CODE\\Global\\Nepali\\CBS_1\\Excel\\Wrongpasswordcheck.xlsx");
...
String mobileno="9894540998,09888244";
String[] s = mobileno.split(",");
for (int i = 0; i < s.length; i++) {
String url ="http://api.myvaluefirst.com/psms/servlet/psms.Eservice2";
URL obj = new URL(url);
...
message.setSubject("Global Desktop Automation Report - PASS ");  /// Global Module Content

message.setRecipients(Message.RecipientType.TO,
InternetAddress.parse("srivijaya.sugumaran@matrimony.com"));  //  Add Email Address To Whom Mail Need to be Send
...
String file = "C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\Report"+html;
   // HtMALReport File Bath  ---   EXtent Report
String fileName = "Global-AutomationReport-Desktop";  // Change CBS to Global or Individual Domain
...
message.setSubject("Global Desktop Automation Report - FAILED");  /// Global Module Content
...
report=new ExtentReports("C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\Report\\"+html,true);
report.loadConfig(new File("C:\\Users\\Vijay\\eclipse-workspace1\\Testmatrimony\\extent-config.xml"));
...
/////////////////////////////  SMS CODE - negative payment////////////////////////////////////////
public static void sendVFSmsnp(String domain,String Error_on,String date1) throws Exception {
String message="[ Global ][ 24/7 QA Monitoring Alert ]\r\n" +
"===================\r\n" +
"Level 1 \r\n" +
"Module : Negativepayment,\r\n" +
"Platform : Desktop,\r\n" +
"Job Status: SUCCESS,\r\n" +
"Domain Name :"+domain+",\r\n" +
"Location : Adayar-Chennai,\r\n" +
...
String mobileno="9894540998,809888244";
String[] s = mobileno.split(",");
for (int i = 0; i < s.length; i++) {
...
public static void sendVFSms1np(String domain,String Error_on,String date1,String failedstatus) throws Exception {
String message="[ Global ][ 24/7 QA Monitoring Alert ]\r\n" +
"===================\r\n" +
"Level 1 \r\n" +
"Module : Negativepayment,\r\n" +
...
public static void reportflush12()
{
report.flush();
final String username = "mohantest.mm@gmail.com";
final String password = "mohanmmteam";
...
public static void sendVFSms1Reg(String domain,String Error_on,String date1,String failedstatus) throws Exception {
String message="[ Global ][ 24/7 QA Monitoring Alert ]\r\n" +
"===================\r\n" +
"Level 1 \r\n" +
"Module : Registration,\r\n" +
...
public static void reportflush21()
{
report.flush();
final String username = "mohantest.mm@gmail.com";
final String password = "mohanmmteam";
...
public static void reportflush121()
{
report.flush();
final String username = "mohantest.mm@gmail.com";
final String password = "mohanmmteam";
