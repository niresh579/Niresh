...
//////////////////////	    Screen SHot    //////////////////////////////////////
	...
	FileInputStream fis = new FileInputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali2\\excel\\Registration1.xls");
	...
	FileInputStream fis = new FileInputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali2\\excel\\Registration1.xls");
	      ...
	      FileOutputStream fos = new FileOutputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali2\\excel\\Registration1.xls");
	wb.write(fos);
	wb.close();
	}
