...
//           driver.setLogLevel(Level.INFO);
  ...
  public void testUntitled() throws Throwable  {
	  ...
	  logger =  report.startTest("Pakistani Send Interest Matches Test");
	...
	logger.log(LogStatus.PASS, "Login Successfully with this Matriid PAK755447");
	 ...
	 try {
	  ...
	  //basic details
		...
		logger.log(LogStatus.PASS, "Handling Basic Details in PI");
  ...
  BaseTest.click(driver.findElement(By.xpath("//li[contains(text(),'"+getExcelData("Data", 1, 1)+"')]")));
	...
	BaseTest.getScreenshot(driver, "Name");
	Thread.sleep(4000);
	...
	logger.log(LogStatus.PASS, "Handling Religious Information in PI");
	try {
		Thread.sleep(4000);
...
//	}
	...
	logger.log(LogStatus.PASS, "Handling Professional Information in PI");
	Thread.sleep(4000);
...
//	
	...
	//location
	  ...
	  logger.log(LogStatus.PASS, "Handling Location in PI");
	  Thread.sleep(4000);
...
try {
	...
	System.out.println("no alert");
	  ...
	  logger.log(LogStatus.PASS, "Handling Family Details in PI");
	  Thread.sleep(4000);
	...
	/////Life Style////  
	  ...
	  logger.log(LogStatus.PASS, "Handling Life style in PI");
	  Thread.sleep(4000);
