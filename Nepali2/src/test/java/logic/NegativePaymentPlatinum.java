...
public class NegativePaymentPlatinum extends BaseTest{
...
//                driver.setLogLevel(Level.INFO);
       ...
       public void testUntitled() throws Throwable {
    	   ...
    	   Thread.sleep(5000);
      	   logger =  report.startTest("Pakistani Negative payment Platinum");
    ...
    logger.log(LogStatus.PASS, "Handling three Month Platinum Packages");	 
   	  Thread.sleep(4000);
...
//     logger.log(LogStatus.PASS, "Handling Six Month PlatinumPackages"); 
//    
//    Thread.sleep(4000);
//    driver.findElement(By.xpath("//*[@id='credit-debit-link8']")).click();
//  	  
...
//     
//     logger.log(LogStatus.PASS, "Handling Till you marriage Platinum Packages"); 
//     Thread.sleep(4000);	
//     driver.findElement(By.xpath("//*[@id='credit-debit-link8']")).click();
//     
//     Thread.sleep(4000);
     		...
     		if (BaseTest.getExcelData("SMS", 1, 2).equals("2")) {
     		    ...
     		    String aa1 = Integer.toString(a1);
     			 ...
     			 BaseTest.reportflush1();       
     		        BaseTest.sendVFSmsnegative1(domain, Error_on, date1, expt);
