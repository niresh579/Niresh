...
//                driver.setLogLevel(Level.INFO);
       ...
       public void testUntitled() throws Throwable {
    	   ...
    	   Thread.sleep(5000);
      	   logger =  report.startTest("Pakistani Profile Preview Test");
...
//height
	...
	try {
		Thread.sleep(4000);
		WebElement txt=driver.findElement(By.xpath("(//span[@class='clr36 font10'])[1]"));
...
///regular search
		 logger.log(LogStatus.PASS, "Handling Regular Search Pages");	
	//age
		Thread.sleep(4000);
	...
	//dosham	
		...
		Thread.sleep(4000);
		driver.findElement(By.xpath("/html/body/ion-app/ng-component/page-search/ion-content/div[2]/ion-grid[2]/ion-row/ion-col/form/div[2]/ion-list/ion-item[2]/div[1]")).click();
...
//				
		...
		//annual income
				...
				Thread.sleep(4000);
				driver.findElement(By.xpath("//*[@id=\"agePanel\"]/div/options/ion-content/div[2]/div/div/ion-list[1]/div/ion-item/div[1]/div")).click();
					
				Thread.sleep(4000);
				driver.findElement(By.xpath("(//span[@class='button-inner'])[25]")).click();
				
				Thread.sleep(4000);
				driver.findElement(By.xpath("(//span[@class='button-inner'])[30]")).click();
				...
				Thread.sleep(4000);
				driver.findElement(By.xpath("(//span[@class='button-inner'])[19]")).click();
