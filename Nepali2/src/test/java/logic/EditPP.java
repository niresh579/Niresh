...
//                driver.setLogLevel(Level.INFO);
       ...
       public void testUntitled() throws Throwable {
       	...
       	Thread.sleep(4000);
 	   logger =  report.startTest("Pakistani Edit PP Test");
   	...
   	logger.log(LogStatus.PASS, "Login Successfully with this Matriid PAK755447");
		...
		logger.log(LogStatus.PASS, "Handling Basic Details in PP");
		...
		try {
			Thread.sleep(4000);
			driver.findElement(By.xpath("//*[@id='editpp-pwa']/div[3]/div[1]/div[2]/a")).click();
		...
		try {
			Thread.sleep(4000);
			driver.findElement(By.xpath("//*[@id=\"editpp-pwa\"]/div[3]/div[1]/div[2]/a/img")).click();
...
//		
		...
		logger.log(LogStatus.PASS, "Handling Religious Information in PP");
		
		Thread.sleep(4000);
		BaseTest.click(rp.getSubcaste());
		Thread.sleep(4000);
		WebElement caste=driver.findElement(By.xpath("//*[@id='chkbox0']"));
		if (caste.isEnabled()) {
			System.out.println("älready selected");
		}
		else {
	...
	logger.log(LogStatus.PASS, "Handling Professional Information in PP");
	  ...
	  logger.log(LogStatus.PASS, "Handling Location Information in PP");
...
//			 
		...
		///pp check/////
		  ...
		  Thread.sleep(4000);
		  WebElement country=driver.findElement(By.xpath("//*[@id='wap-edit-profile']/div[3]/div[9]/div[2]/ul/li[1]/div[2]"));
		  ...
		  System.out.println("finalcountry in pp:"+countrypp);
		  
		  
		  
		  Thread.sleep(4000);
		  WebElement state1=driver.findElement(By.xpath("//*[@id='wap-edit-profile']/div[3]/div[9]/div[2]/ul/li[2]/div[2]"));
		  ...
		  Thread.sleep(4000);
		  WebElement city1=driver.findElement(By.xpath("//*[@id='wap-edit-profile']/div[3]/div[9]/div[2]/ul/li[3]/div[2]"));
		  ...
		  Thread.sleep(4000);
		  WebElement citizenship1=driver.findElement(By.xpath("//*[@id='wap-edit-profile']/div[3]/div[9]/div[2]/ul/li[4]/div[2]"));
		  ...
		  logger.log(LogStatus.PASS, "Validating all the datas in PP");  
		  ...
		  if (countrypp.contains(countrypp1)) {
