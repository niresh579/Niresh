...
//                 driver.setLogLevel(Level.INFO);
        ...
        public void testUntitled() throws InterruptedException {
        	...
        	MatchesPOM rp= new MatchesPOM(driver);
        	 Thread.sleep(5000);
      	   logger =  report.startTest("Pakistani shortlisted multiple profile in matches");
        ...
        System.out.println("profile :"+b1);
		 ...
		 Thread.sleep(4000);
		 	 ...
		 	 WebElement any = driver.findElement(By.xpath("/html/body/ion-app/ng-component/page-matches/ion-content/div[2]/ion-list/ion-row[\"+i+\"]/ion-grid/ion-row[2]/ion-col[1]"));
				  Thread.sleep(4000); 
				  ref.get(i).click();
			  Thread.sleep(3000);
			  }	  
