...
public class Bug_Report extends BaseTest{
	 ...
	 String Status;
	 String path ="E:\\Automation\\Bugzilla\\data\\";
	public static WebDriver driver;
	public static String No_Bug;

    String driverExecutablePath = 
      "C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\drivernew\\chromedriver.exe";
	
	@BeforeSuite
	public void setUp() {
	    System.setProperty("webdriver.chrome.driver","C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\drivernew\\chromedriver.exe");
	...
	@Test(retryAnalyzer=logic.RetryFailedTestCases.class)
...
driver.findElement(By.xpath("//*[@id='v1_classification']")).click();
         ...
         driver.findElement(By.xpath("//*[@id='v59_product']")).click();
//*[@id="v1_classification"]
           bot.keyPress(java.awt.event.KeyEvent.VK_CONTROL);
           


driver.findElement(By.xpath("//*[@id='v61_product']")).click();

driver.findElement(By.xpath("//*[@id='v60_product']")).click();
