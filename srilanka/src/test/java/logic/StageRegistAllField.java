...
import test.srilanka.StageRegistAllFieldPOM;
...
//             driver.setLogLevel(Level.INFO);
	...
	public void test() throws Throwable {
		...
		Thread.sleep(4000);
		 logger =  report.startTest("Srilankan Registration");
		driver.get("https://m.srilankanmatrimony.com/cbsmob/registration/register.php");
		Thread.sleep(4000);
...
//		
		...
		logger.log(LogStatus.PASS, " Entered MotherTongue");
