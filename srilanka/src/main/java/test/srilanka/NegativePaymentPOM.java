...
public class NegativePaymentPOM {
	...
	@FindBy(xpath="//div[contains(text(),'Diamond Pack  (3 Months)')]")
	private WebElement threemonthdiamond;
	


	public WebElement getThreemonthdiamond() {
		return threemonthdiamond;
	}
