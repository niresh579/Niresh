...
//////////////////////	    Screen SHot    //////////////////////////////////////
	...
	FileInputStream fis = new FileInputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\excel\\Registration1.xls");
	...
	FileInputStream fis = new FileInputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\excel\\Registration1.xls");
	      ...
	      FileOutputStream fos = new FileOutputStream("C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\excel\\Registration1.xls");
	wb.write(fos);
	wb.close();
	}
	...
	public static List<HashMap<String, String>> readValueFromExcelSheet()  throws NullPointerException  {
		...
		try {
			File excelLocaltion = new File("C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\excel\\Registration1.xls");
...
"http://api.myvaluefirst.com/psms/servlet/psms.Eservice2";
 ...
 public static void reportflush()
 {
     ...
     try {
         ...
         message.setSubject("Nepali Matrimony Report ");  /// Global Module Content
      
         message.setRecipients(Message.RecipientType.TO,
                     InternetAddress.parse("nireshkumar.k@matrimony.com"));  //  Add Email Address To Whom Mail Need to be Send
            //,thanikachalam.thirunanasambandan@matrimony.com                        
         Multipart multipart = new MimeMultipart();

         MimeBodyPart messageBodyPart = new MimeBodyPart();
         messageBodyPart.setText("Nepali Matrimony Report");
         MimeBodyPart attachmentBodyPart = new MimeBodyPart();       
       

         String file = "C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali\\excel\\report.html";
                         // HtMALReport File Bath  ---   EXtent Report
         String fileName = "Global Nepali Matrimony Report";  // Change CBS to Global or Individual Domain
 ...
 @BeforeSuite
	public void htmlReport() {
	    ...
	    // extent = new ExtentHtmlReporter("C:\\Users\\amuthan\\eclipse-workspace\\com.mobile\\ScreenShot");
		 ...
		 report=new ExtentReports("C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\Report\\"+html,true);
		 report.loadConfig(new File("C:\\Users\\CBS Testing\\workspace\\Niresh\\srilanka\\test-output\\extent-config.xml"));
