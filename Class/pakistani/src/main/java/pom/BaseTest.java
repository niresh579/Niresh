...
//////////////////////	    Screen SHot    //////////////////////////////////////
	...
	public static String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
	 ...
	 String destination = "C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali2\\screenshots\\" +screenshotName+".png";
...
"Platform : Desktop,\r\n" + 
"Error on : "+Error_on+",\r\n" + 
	"Error Description : no such element,\r\n" + 
	"Domain Name : pakistanimatrimony.com,\r\n" + 
"Location : Adayar-Chennai,\r\n" + 
""+date1+"";
 ...
 @BeforeSuite
	public void htmlReport() {
	    ...
	    // extent = new ExtentHtmlReporter("C:\\Users\\amuthan\\eclipse-workspace\\com.mobile\\ScreenShot");
		 ...
		 report=new ExtentReports("C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali\\excel\\report\\"+html,true);
		 report.loadConfig(new File("C:\\Users\\CBS Testing\\workspace\\Niresh\\Nepali\\registration.xml"));
